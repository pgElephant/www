...
LIMIT 20;`}</code>
        ...
        <section>
          ...
          <div className="bg-gray-900/50 rounded-lg p-6 border border-gray-700">
            <ul className="space-y-2 text-gray-300">
              <li><a href="https://github.com/pgelephant/pg_stat_insights/tree/main/sql/select.sql" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 hover:underline">📄 sql/select.sql</a> - SELECT query tracking</li>
              <li><a href="https://github.com/pgelephant/pg_stat_insights/tree/main/sql/planning.sql" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 hover:underline">📄 sql/planning.sql</a> - Planning time analysis</li>
              <li><a href="https://github.com/pgelephant/pg_stat_insights/tree/main/sql/dml.sql" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 hover:underline">📄 sql/dml.sql</a> - DML statement performance</li>
            </ul>
          </div>
        </section>
      </div>
