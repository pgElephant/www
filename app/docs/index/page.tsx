    ...
    <div className="min-h-screen bg-white dark:bg-slate-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6">
              pgElephant
              <span className="block text-3xl md:text-4xl text-slate-600 dark:text-slate-400 font-light mt-2">
                Documentation
              </span>
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <div className="bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-4 py-2 rounded-lg text-slate-700 dark:text-slate-300">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Product Documentation</h2>
          <p className="text-slate-600 dark:text-slate-400 text-lg">Comprehensive guides for each pgElephant product</p>
        </div>

        <div className="space-y-12">
          {products.map((product, productIndex) => (
            <div key={productIndex} className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-8">
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {product.features.map((feature, featureIndex) => (
                    <span key={featureIndex} className="px-3 py-1 rounded-full text-sm bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-600">
                      {feature}
                    </span>
                  ))}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {product.documentation.map((doc, docIndex) => (
                  <a
                    key={docIndex}
                    href={doc.href}
                    className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg p-4 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors group"
                  >
                    <div className="flex items-center mb-2">
                      <div className="text-slate-600 dark:text-slate-400 mr-2 group-hover:text-slate-700 dark:group-hover:text-slate-300">
                        {doc.icon}
                      </div>
                      <h5 className="font-semibold text-slate-900 dark:text-white group-hover:text-slate-700 dark:group-hover:text-slate-200">
                        {doc.title}
                      </h5>
                    </div>
      ...
      <div className="bg-slate-50 dark:bg-slate-800 py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Quick Start Guides</h2>
            <p className="text-slate-600 dark:text-slate-400 text-lg">Get up and running quickly with these step-by-step guides</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {quickStartGuides.map((guide, index) => (
              <a
                key={index}
                href={guide.href}
                className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-6 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group"
              >
                <div className="flex items-center mb-4">
                  <div className="text-slate-600 dark:text-slate-400 mr-3 group-hover:text-slate-700 dark:group-hover:text-slate-300">
                    {guide.icon}
                  </div>
                  <h3 className="text-xl font-semibold text-slate-900 dark:text-white group-hover:text-slate-700 dark:group-hover:text-slate-200">
                    {guide.title}
                  </h3>
                </div>
                ...
                <div>
                  <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Steps</h4>
                  <ol className="space-y-1">
                    {guide.steps.map((step, stepIndex) => (
                      <li key={stepIndex} className="text-slate-600 dark:text-slate-400 text-sm flex items-center">
                        <span className="bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs rounded-full w-5 h-5 flex items-center justify-center mr-3">
                          {stepIndex + 1}
                        </span>
                        {step}
                      </li>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">API References</h2>
          <p className="text-slate-600 dark:text-slate-400 text-lg">Complete API documentation with examples and code samples</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {apiReferences.map((api, index) => (
            ...
            >
              ...
              <div>
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Key Endpoints</h4>
                <div className="flex flex-wrap gap-2">
                  {api.endpoints.map((endpoint, endpointIndex) => (
                    <span key={endpointIndex} className="px-2 py-1 rounded text-sm bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-600">
                      {endpoint}
                    </span>
                  ))}
                </div>
      ...
      <div className="bg-slate-50 dark:bg-slate-800 py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Troubleshooting</h2>
            <p className="text-slate-600 dark:text-slate-400 text-lg">Common issues, error messages, and solutions</p>
          </div>
            ...
            {troubleshootingGuides.map((guide, index) => (
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white group-hover:text-slate-700 dark:group-hover:text-slate-200">
                    {guide.title}
                  </h3>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1">
                    {guide.categories.map((category, categoryIndex) => (
                      <span key={categoryIndex} className="px-2 py-1 rounded text-xs bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-600">
                        {category}
                      </span>
                    ))}
                  </div>
      ...
      <div className="bg-slate-50 dark:bg-slate-800 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">Additional Resources</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <a
              ...
              className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-6 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group"
            >
              <Activity className="w-8 h-8 text-slate-600 dark:text-slate-400 mb-4 group-hover:text-slate-700 dark:group-hover:text-slate-300" />
              <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">pgSentinel Product</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm">Learn more about the monitoring platform</p>
            </a>
            ...
            <a
              ...
              className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-6 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group"
            >
              <Database className="w-8 h-8 text-slate-600 dark:text-slate-400 mb-4 group-hover:text-slate-700 dark:group-hover:text-slate-300" />
              <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">pg_stat_insights Product</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm">Explore the performance analytics tool</p>
            </a>
            ...
            <a
              ...
              className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-6 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group"
            >
              <Code className="w-8 h-8 text-slate-600 dark:text-slate-400 mb-4 group-hover:text-slate-700 dark:group-hover:text-slate-300" />
              <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">GitHub Repository</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm">View source code and contribute</p>
            </a>
          </div>
        </div>
      </div>
