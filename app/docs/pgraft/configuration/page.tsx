...
export default function PgraftConfigurationPage() {
  return (
    <div className="space-y-12">
      <div>
        <h1 className="text-4xl font-bold mb-4">pgraft Configuration</h1>
        <p className="text-lg text-muted-foreground">
          Configure PostgreSQL and pgraft to operate as a reliable Raft cluster. This guide covers baseline server
          settings, pgraft GUC parameters, runtime management functions, and performance profiles for different workloads.
        </p>
      </div>
