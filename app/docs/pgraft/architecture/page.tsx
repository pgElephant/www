  ...
  return (
    <DocsContentLayout
      hero={{
        ...
        description:
          'pgraft embeds the Raft consensus algorithm inside PostgreSQL using a mix of C hooks and a Go replication worker. The architecture keeps durability guarantees aligned with PostgreSQL while adding deterministic leader election, quorum-based writes, and automatic failover.',
      }}
      contentWidth="wide"
    >
      <div className="space-y-12">
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-4">pgraft adheres to Raft&apos;s safety properties:</p>
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
