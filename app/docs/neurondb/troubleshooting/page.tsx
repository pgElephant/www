          ...
          <div className="p-4 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>Verify NeuronDB was compiled with GPU support: Check build logs for <code>-DUSE_GPU</code></pre></li>
                <li>Ensure CUDA or ROCm drivers are installed: <code>nvidia-smi</code></pre> or <code>rocm-smi</code></pre></li>
                <li>Check GPU device availability: <code>ls /dev/nvidia*</code></pre> or <code>ls /dev/kfd</code></pre></li>
                <li>Set <code>neurondb.gpu_fail_open = true</code></pre> to fallback to CPU on GPU errors</li>
              </ul>
...
SET neurondb.log_level = 'debug';`}</code></pre></pre>
          ...
          <div className="p-4 border border-yellow-200 dark:border-yellow-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <p><strong>Solutions:</strong></p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>Increase <code>neurondb.gpu_batch_size</code></pre> (try 1000–10000 for large datasets)</li>
                <li>Use multiple streams: <code>SET neurondb.gpu_streams = 8;</code></pre></li>
                <li>Increase memory pool: <code>SET neurondb.gpu_memory_pool_mb = 1024;</code></pre></li>
...
SET neurondb.gpu_memory_pool_mb = 2048;`}</code></pre></pre>
          ...
          <div className="p-4 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <p><strong>Solutions:</strong></p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>Reduce <code>neurondb.gpu_batch_size</code></pre></li>
                <li>Lower <code>neurondb.gpu_memory_pool_mb</code></pre></li>
        ...
        <div className="space-y-6">
          <div className="p-4 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <p><strong>Solutions:</strong></p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>Increase <code>max_iter</code></pre> parameter (e.g., 200, 500)</li>
                <li>Adjust tolerance: lower <code>tol</code></pre> for faster convergence</li>
                <li>Try different <code>k</code></pre> values; too many clusters can slow convergence</li>
...
SELECT * FROM cluster_kmeans(
  ...
  0.001  -- relaxed tolerance
          ...
          <div className="p-4 border border-yellow-200 dark:border-yellow-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              <p><strong>Cause:</strong> Inappropriate <code>k</code></pre>, non-normalized embeddings, or skewed data distribution.</p>
              <p><strong>Solutions:</strong></p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>Normalize embeddings before clustering (especially for GMM)</li>
                <li>Use elbow method or silhouette analysis to find optimal <code>k</code></pre></li>
        ...
        <div className="space-y-6">
          <div className="p-4 border border-yellow-200 dark:border-yellow-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <p><strong>Solutions:</strong></p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>Verify index operator class matches query: <code>vector_l2_ops</code></pre> for <code>&lt;-&gt;</code></pre></li>
                <li>Check index exists: <code>\d tablename</code></pre></li>
                <li>Use <code>EXPLAIN ANALYZE</code></pre> to verify index usage</li>
                <li>Increase <code>effective_cache_size</code></pre> if planner prefers sequential scan</li>
              </ul>
              <pre className="bg-muted p-3 rounded mt-2 overflow-x-auto">
                <code>{`
-- Verify index usage
...
SET enable_seqscan = off;`}</code></pre></pre>
          ...
          <div className="p-4 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <p><strong>Solutions:</strong></p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>Increase <code>maintenance_work_mem</code></pre> (e.g., 2GB, 4GB)</li>
                <li>Lower <code>m</code></pre> or <code>ef_construction</code></pre> parameters</li>
...
WITH (lists = 100);`}</code></pre></pre>
          ...
          <div className="p-4 border border-yellow-200 dark:border-yellow-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <p><strong>Solutions:</strong></p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>Increase <code>hnsw.ef_search</code></pre> (HNSW) or <code>ivfflat.probes</code></pre> (IVF)</li>
                <li>Rebuild index with higher <code>ef_construction</code></pre> (HNSW) or more <code>lists</code></pre> (IVF)</li>
        ...
        <div className="space-y-6">
          <div className="p-4 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <p><strong>Solutions:</strong></p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>Verify <code>neurondb.llm_api_key</code></pre> is set correctly</li>
...
ALTER DATABASE mydb SET neurondb.llm_api_key = 'sk-...';`}</code></pre></pre>
          ...
          <div className="p-4 border border-yellow-200 dark:border-yellow-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <p><strong>Solutions:</strong></p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>Increase <code>neurondb.llm_timeout_ms</code></pre> (default 30000ms)</li>
                <li>Reduce batch size for <code>neurondb_embed_batch</code></pre></li>
                <li>Enable retries: <code>SET neurondb.llm_max_retries = 5;</code></pre></li>
          ...
          <div className="p-4 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <ul className="list-disc list-inside ml-4 space-y-1">
                ...
                <li>Match column definition: <code>ALTER TABLE ... ALTER COLUMN embedding TYPE vector(3072);</code></pre></li>
                <li>Use correct model name when calling <code>neurondb_embed</code></pre></li>
              </ul>
              <pre className="bg-muted p-3 rounded mt-2 overflow-x-auto">
                <code>{`
          ...
          <div className="p-4 border border-yellow-200 dark:border-yellow-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <ul className="list-disc list-inside ml-4 space-y-1">
                ...
                <li>Tune runtime GUCs: <code>hnsw.ef_search</code></pre>, <code>ivfflat.probes</code></pre></li>
          ...
          <div className="p-4 border border-yellow-200 dark:border-yellow-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <ul className="list-disc list-inside ml-4 space-y-1">
                ...
                <li>Lower HNSW <code>m</code></pre> parameter</li>
                <li>Use vector quantization (int8, fp16, binary) to reduce storage</li>
                <li>Increase <code>shared_buffers</code></pre> and <code>effective_cache_size</code></pre></li>
              </ul>
              <pre className="bg-muted p-3 rounded mt-2 overflow-x-auto">
                <code>{`
      ...
      <section>
        ...
        <div className="space-y-3">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Enable <code>neurondb.log_level = 'debug'</code></pre> for verbose output</li>
