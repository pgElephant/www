          ...
          <div className="p-4 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <pre className="bg-muted p-3 rounded mt-2 overflow-x-auto">
                <code>{`-- Enable fail-open mode (CPU fallback)
...
SET neurondb.log_level = 'debug';`}</code>
          ...
          <div className="p-4 border border-yellow-200 dark:border-yellow-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <pre className="bg-muted p-3 rounded mt-2 overflow-x-auto">
                <code>{`-- Optimize for large batches
        ...
        <div className="space-y-6">
          <div className="p-4 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <pre className="bg-muted p-3 rounded mt-2 overflow-x-auto">
                <code>{`-- Increase iterations and relax tolerance
  ...
  5, 100, 0.0001
          ...
          <div className="p-4 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <pre className="bg-muted p-3 rounded mt-2 overflow-x-auto">
                <code>{`-- Lower threshold for more outliers
...
SET enable_seqscan = off;`}</code>
          ...
          <div className="p-4 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <pre className="bg-muted p-3 rounded mt-2 overflow-x-auto">
                <code>{`-- Increase memory for index build
...
WITH (lists = 100);`}</code>
          ...
          <div className="p-4 border border-yellow-200 dark:border-yellow-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <pre className="bg-muted p-3 rounded mt-2 overflow-x-auto">
                <code>{`-- Increase search width for HNSW
        ...
        <div className="space-y-6">
          <div className="p-4 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <pre className="bg-muted p-3 rounded mt-2 overflow-x-auto">
                <code>{`-- Set API key (session-level for testing)
...
ALTER DATABASE mydb SET neurondb.llm_api_key = 'sk-...';`}</code>
          ...
          <div className="p-4 border border-yellow-200 dark:border-yellow-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <pre className="bg-muted p-3 rounded mt-2 overflow-x-auto">
                <code>{`-- Increase timeout and retries
  ...
  'text-embedding-ada-002'
          ...
          <div className="p-4 border border-red-200 dark:border-red-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <pre className="bg-muted p-3 rounded mt-2 overflow-x-auto">
                <code>{`-- Check current column dimension
        ...
        <div className="space-y-6">
          ...
          <div className="p-4 border border-yellow-200 dark:border-yellow-800 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <pre className="bg-muted p-3 rounded mt-2 overflow-x-auto">
                <code>{`-- Use quantization to save memory
...
WHERE tablename = 'documents';`}</code>
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`-- View current NeuronDB settings
