  ...
  return (
    <DocsContentLayout
      hero={{
        ...
        description:
          'Three production-ready background workers for async operations, auto-tuning, and index maintenance. Built with PostgreSQL background workers and tenant isolation for predictable operations.',
      }}
