...
-- Cast from array
SELECT ARRAY[1.0, 2.0, 3.0]::vector(3);`}</code>
            </pre>
          </div>
        </div>
      </section>
...
FROM source_documents;`}</code>
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`-- Batch embed multiple texts
...
WHERE documents.id = batch.id;`}</code>
            </pre>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="space-y-6">
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SET neurondb.gpu_enabled = true;
...
FROM documents;`}</code>
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SELECT vector_cosine_distance_gpu(embedding, '[1,2,3]'::vector)
FROM documents;`}</code>
            </pre>
          </div>
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SELECT vector_inner_product_gpu(embedding, '[1,2,3]'::vector)
FROM documents;`}</code>
            </pre>
          </div>
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SELECT vector_to_int8_gpu(embedding) FROM documents;`}</code>
            </pre>
          </div>
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SELECT vector_to_fp16_gpu(embedding) FROM documents;`}</code>
            </pre>
          </div>
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SELECT vector_to_binary_gpu(embedding) FROM documents;`}</code>
            </pre>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="space-y-6">
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SELECT * FROM cluster_kmeans(
  ...
  0.0001  -- tolerance
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SELECT * FROM cluster_minibatch_kmeans(
  (SELECT embedding FROM documents),
  10,  -- 10 clusters
  1000,  -- batch size
  50  -- max iterations
...
FROM documents;`}</code>
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`-- Detect outliers with Z-score > 3
SELECT 
  id,
  (stats).is_outlier,
  (stats).z_score
...
WHERE (stats).is_outlier;`}</code>
      ...
      <section>
        ...
        <div className="space-y-6">
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SELECT neurondb_create_ml_project(
  'customer_segments',
  'K-means clustering of customer embeddings'
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SELECT neurondb_train_kmeans_project(
  1,  -- project_id
  ...
  100  -- max iterations
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SELECT * FROM neurondb_list_project_models(1);`}</code>
            </pre>
          </div>
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SELECT neurondb_deploy_model(42, 'production_clusters');`}</code>
            </pre>
          </div>
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SELECT neurondb_get_deployed_model('production_clusters');`}</code>
            </pre>
          </div>
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SELECT neurondb_get_project_info(1);`}</code>
            </pre>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="space-y-6">
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`-- Hybrid search: 70% vector, 30% full-text
...
LIMIT 10;`}</code>
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`-- Configure reranking model
      ...
      <section>
        ...
        <div className="space-y-6">
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`-- Enable background workers
...
SELECT neurondb_schedule_embedding_update(
  ...
  'text-embedding-ada-002'
          ...
          <div>
            ...
            <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
              <code>{`SELECT * FROM neurondb_worker_status();`}</code>
            </pre>
          </div>
        </div>
      </section>
