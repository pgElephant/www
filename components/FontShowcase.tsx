...
const FontShowcase = () => {
  return (
    <section className="section-padding bg-gradient-to-br from-neutral-900 via-primary-900 to-neutral-900 relative overflow-hidden">
      <div className="container-extra-wide">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-6 leading-tight">
            ...
            <br />
            <span className="text-primary-300 font-heading">Showcase</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-primary-400/30">
            <h3 className="text-2xl font-heading font-bold text-primary-300 mb-4">Display Font</h3>
            <div className="space-y-4">
              ...
              <code className="block bg-black/50 text-accent-400 p-3 rounded font-mono text-sm">
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-secondary-400/30">
            <h3 className="text-2xl font-heading font-bold text-secondary-300 mb-4">Heading Font</h3>
            <div className="space-y-4">
          ...
          {/* Body Font - Inter */}
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-accent-400/30">
            <h3 className="text-2xl font-heading font-bold text-accent-300 mb-4">Body Font</h3>
            <div className="space-y-4">
          ...
          <div className="bg-black/50 backdrop-blur-sm rounded-2xl p-8 border border-cyan-400/30">
            ...
            <div className="space-y-4">
              <div className="bg-black rounded p-4 font-mono text-sm text-accent-400">
                <div>$ ./run.sh init</div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-slate-400/30 max-w-4xl mx-auto">
            <div className="space-y-4 text-left">
              <div className="flex items-center justify-between border-b border-slate-600 pb-2">
                ...
                <code className="font-mono text-accent-400">font-display text-6xl</code>
              </div>
              <div className="flex items-center justify-between border-b border-slate-600 pb-2">
                <span className="text-4xl font-heading font-bold text-white">H2</span>
                <code className="font-mono text-accent-400">font-heading text-4xl</code>
              </div>
              <div className="flex items-center justify-between border-b border-slate-600 pb-2">
                <span className="text-2xl font-heading font-bold text-white">H3</span>
                <code className="font-mono text-accent-400">font-heading text-2xl</code>
              </div>
              <div className="flex items-center justify-between border-b border-slate-600 pb-2">
                <span className="text-xl font-body text-white">Body Large</span>
                <code className="font-mono text-accent-400">font-body text-xl</code>
              </div>
              <div className="flex items-center justify-between border-b border-slate-600 pb-2">
                <span className="text-base font-body text-white">Body Regular</span>
                <code className="font-mono text-accent-400">font-body text-base</code>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm font-mono text-accent-400">Code / Terminal</span>
                <code className="font-mono text-accent-400">font-mono text-sm</code>
              </div>
            </div>
          </div>
        </div>
