...
export const products: Record<ProductId, ProductMetadata & ProductFeatures & ProductBadges> = {
  ...
  pgraft: {
    ...
    description: 'Raft consensus for PostgreSQL with automatic leader election, crash-safe replication, and split-brain prevention.',
    longDescription: 'Raft consensus for distributed PostgreSQL clusters. Built on etcd-io/raft with automatic leader election, crash-safe replication, split-brain prevention, zero-downtime failover, and SQL API. Background worker architecture with no external dependencies.',
    keywords: [
  ...
  pgbalancer: {
    ...
    tagline: 'PostgreSQL Load Balancer and Connection Pooler',
    description: 'PostgreSQL connection pooler with load balancing, REST API management, and MQTT event streaming.',
    longDescription: 'Connection pooler with load balancing, REST API management, and MQTT event streaming. Query routing uses machine learning to keep PostgreSQL clusters responsive under any workload. Fork of pgpool-II with machine learning algorithms for query routing.',
    keywords: [
  ...
  pgsentinel: {
    ...
    tagline: 'PostgreSQL Monitoring Platform',
    description: 'Web-based monitoring platform for pgbalancer with real-time metrics, Prometheus integration, and dashboards.',
    longDescription: 'Real-time monitoring with Grafana dashboards. Alerting system with Prometheus integration. Performance analytics with query optimization insights. Docker-based deployment with observability stack. Monitoring with automated health checks.',
    keywords: [
  ...
  'pg-stat-insights': {
    ...
    tagline: 'PostgreSQL Performance Analytics',
    description: 'Query performance analysis with pg_stat_statements, table and index usage statistics, and optimization recommendations.',
    longDescription: 'Query performance analysis with pg_stat_statements. Table and index usage statistics with optimization recommendations. Cache hit ratio monitoring with buffer pool analysis. Replication lag tracking with failover insights. Database health metrics and reporting.',
    keywords: [
